...
# Assuming 'choice' is the user's input (Y/y or N/n)
choice = input("Do you wish to use the hard-coded Webex token? (y/n) ")
...
if choice.lower() == 'n':
    ...
    accessToken = "your_hard_coded_token_here"

	accessToken = NjE0NWI0ZmQtNzBhZS00NWY4LThkMDgtMWI2MDdkZDAyNzM1YWY2MTQxMzMtYWYw_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "0rjwpC3tMrR7gS8G5tNHfSiDuYUVcmKg"
                               }
# 7. Provide the URL to the MapQuest GeoCode API.
        r = requests.get("https://sunrise-sunset.org/api", 
...
# 11. Complete the code to format the response message.
        responseMessage = "In {} the sun will rise at {} and will set at {} . The day will last {} seconds.".format "f"In {location} the sun will rise at {sunrise} and will set at {sunset}. The day will last {day_length} seconds."
